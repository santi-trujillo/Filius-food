      ...
      <article class="product-card" data-product-id="${product.id}">
        <div class="product-card__image-wrapper">
          <img 
            ...
            onload="this.closest('.product-card').style.display='block'"
          >
          ${badge}
        </div>
        <div class="product-card__content">
          ...
          <button 
            ...
            onclick="window.open('https://wa.me/573196614444?text=Hola,%20me%20interesa%20el%20producto:%20${encodeURIComponent(
              product.name
            )}', '_blank')"
          >
            Pedir
